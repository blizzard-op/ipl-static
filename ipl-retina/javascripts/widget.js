...
(function() {
  var authCheck, calculatePercent, checkForNewPolls, createDescription, createPoll, currentStreams, descriptionText, getPayouts, getPoll, getPollInterval, getPolls, getStreams, getVotes, init, loadPolls, loadUser, loadVideo, loadWidget, pollForStream, pollsObj, postVote, randomizeOrder, readCookie, streamKeys, updatePoll, updatePollView, updateVotes, userId, _mediaUrl, _url;
  ...
  createPoll = function(poll) {
    ...
    pollHTML = "<div id='" + poll.id + "' class='results'>\n  <img src='http://" + _mediaUrl + "/ev/esports/ipl-static/ipl-site/images/ipl5-150x115.png' alt='IPL5 logo' />\n  <h4>Who Will Win Game " + poll.matchup.game.number + "?</h4>\n  <div class=\"label clearfix\">";
    _ref = poll.options;
    ...
    if (userId !== 21) {
      ...
      pollHTML += "<p><a href='https://s.ign.com/' class='signin'>Log in</a> to have your scores tracked and win an IPL PC!</p>";
    }
  ...
  getPayouts = function(pollId, userId) {
    ...
    fetchingPayouts.done(function(data) {
      ...
      if (userId === 21) {
        ...
        $("#payout-" + pollId).html(pollsObj[pollId].payout);
  ...
  checkForNewPolls = function(streamId) {
    var clearInterval, newPollInterval;
  ...
  loadPolls = function(pollData, streamId) {
    var currentPoll, poll, polls, _i, _j, _len, _len1;
    polls = "";
    currentPoll = "";
    if (streamId != null) {
