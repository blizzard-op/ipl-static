...
(function() {
  var authCheck, calculatePercent, createPoll, currentStreams, descriptionText, getPayouts, getPolls, getStreams, getVotes, init, loadPolls, loadUser, loadVideo, loadWidget, pollForStream, pollsObj, postVote, randomizeOrder, readCookie, socket, streamKeys, updateVotes, userId, _mediaUrl, _url;

  _url = "esports.ign.com:80";

  _mediaUrl = "media.ign.com";

  socket = io.connect("http://" + _url);
