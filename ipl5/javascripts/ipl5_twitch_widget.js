(function() {
  ...
  loadVideo = function(IGNId) {
    ...
    var embed = '<object type="application/x-shockwave-flash" height="360" width="640" data="http://www.justin.tv/widgets/live_embed_player.swf?channel=' + IGNId + ' bgcolor="#000000" id="live_embed_player_flash"><param name="allowFullScreen" value="true"><param name="allowScriptAccess" value="always"><param name="allowNetworking" value="all"><param name="movie" value="http://www.justin.tv/widgets/live_embed_player.swf"><param name="flashvars" value="hostname=www.twitch.tv&amp;channel=' + IGNId + '&amp;auto_play=true&amp;start_volume=50"></object>';
