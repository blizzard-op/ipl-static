...
(function() {
  var addLeadingZero, createPaginationList, fetchArticles, loadAllArticles, loadArticle, replaceIframe, replaceYoutube, setQueryParams;
  ...
  fetchArticles = function(params, cb) {
    var queryParams;
    queryParams = {
      page: params.page || 1,
