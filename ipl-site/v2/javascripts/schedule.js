...
(function() {
  var $scheduleTemplate, scheduleTemplate, tmpl, today, week;
  ...
  (function() {
    ...
    return fetchingEvents.done(function(events) {
      var date, dates, diff, firstEvent, formattedDay, groupOfEvents, key, mdate, newDate, previousDay, rows, value, _i, _len;
      rows = '';
